...
#define MIDI_NOTE_BREVE				1536	/*Whole note*/
#define MIDI_NOTE_MINIM				 768    /*Half note*/
#define MIDI_NOTE_CROCHET			 384	/*Quarter note*/
#define MIDI_NOTE_QUAVER		 	 192	/*Eighth note*/
#define MIDI_NOTE_SEMIQUAVER		  96	/*16th note*/
#define MIDI_NOTE_SEMIDEMIQUAVER	  48	/*32th note*/

#define MIDI_NOTE_DOTTED_MINIM				 (768+384)	/*Dotted Half note*/
#define MIDI_NOTE_DOTTED_CROCHET		 (384+192)	/*Dotted Quarter note*/
#define MIDI_NOTE_DOTTED_QUAVER		 (192+96)	/*Dotted Eighth note*/
#define MIDI_NOTE_DOTTED_SEMIQUAVER			  (96+48)	/*Dotted 16th note*/
#define MIDI_NOTE_DOTTED_SEMIDEMIQUAVER	  (48+24)		/*Dotted 16th note*/

#define MIDI_NOTE_TRIPLE_CROCHET	256			/* 3 notes in 2 crochet */      /*TRIPLET*/


/*
** Notes - Volume
*/
#define MIDI_VOL_FORTISSIMO 	127
#define MIDI_VOL_MEZZO_FORTE 	95
#define MIDI_VOL_MEZZO			64
#define MIDI_VOL_MEZZO_PIANO	45
#define MIDI_VOL_PIANO			20
